...
public partial class EntityPending
{
    ...
    public virtual EntitySubType? FkEntitySubType { get; set; }

    public virtual User? FkRequestedUser { get; set; }

    public virtual EntityStatus FkStatus { get; set; } = null!;
}
